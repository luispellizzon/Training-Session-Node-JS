const { badRequest, serverError, noContent, forbidden } = require("../../helpers/http-helper")
...
class CreateSessionController{
  ...
  async handle (request) {
    try {
      ...
      const isBookingExists = await this.#loadSessionByUserIdAndDate.loadByUserIdAndDate(user_id, bookingDate)
      if (isBookingExists) {

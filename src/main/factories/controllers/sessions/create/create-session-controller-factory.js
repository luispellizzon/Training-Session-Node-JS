...
const createSessionControllerFactory = () => {
  ...
  const loadSessionByUserIdAndDate = new DbLoadSessionByUserIdAndDate(loadSessionByUserIdAndDateRepository)
  ...
  const controller = new CreateSessionController(validators, loadSessionByUserIdAndDate, createSession)
  return controller
}
